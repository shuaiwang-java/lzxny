...
<body style="width:100%; height:100%; background-color:#FFFFF3">
		...
		<div class="page-header">
		  <h1>个人文件 <small>上传下载个人文件</small></h1>
		</div>
		...
		<script type="text/javascript">
			...
			function get_FileList(){
				$.ajax({
					url:"${app_path}/get/fileListaticll",
					type:"POST",
	        ...
	        function download1(fname){
	        	...
	        	$('body').append(form);  
	                ...
	                form.attr('action',"${app_path}/file/download");//下载文件的请求路径
	                var input1 = $('<input>'); 
