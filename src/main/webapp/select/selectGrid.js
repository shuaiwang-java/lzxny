...
; (function ($) {
    ...
    $.fn.selectGrid = function (options) {
        ...
        if (defaults.filter == true) {
            var search = $('<div id="select_grid_search" class="layui-row"><div class=" layui-col-xs8 col-1"><input type="text" class="layui-input"></div><div class="layui-col-xs4 col-2" style="text-align: center;"><button class="layui-btn layui-btn-sm ">输入关键字快速查询</button></div></div>');
